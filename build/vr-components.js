...
exports.register = function(name, props) {
  ...
  // Components are extendable by default but can be declared
  // as non extendable as an optimization to avoid
  // storing the template strings
  var extendable = props.extendable =
    props.hasOwnProperty('extendable')? props.extendable : true;
